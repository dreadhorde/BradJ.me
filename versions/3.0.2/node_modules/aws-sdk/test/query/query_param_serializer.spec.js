  ...
  describe('QueryParamSerializer', function() {
    ...
    describe('lists', function() {
      describe('flattened', function() {
        ...
        it('supports queryFlattened key', function() {
          var params, rules;
          rules = {
            Name: {
              type: 'list',
        ...
        it('supports lists of complex types', function() {
          ...
          return expect(params.sort()).toEqual([['Root.1.Aa', 'a1'], ['Root.1.Bb', 'b1'], ['Root.2.Aa', 'a2'], ['Root.2.Bb', 'b2']]);
        });
    ...
    return describe('timestamps', function() {
      it('serializes timestamp to iso8601 strings by default', function() {
        ...
        return expect(params).toEqual([['Date', helpers.util.date.iso8601(date)]]);
      });
      return it('obeys format options in the rules', function() {
        ...
        return expect(params).toEqual([['Date', helpers.util.date.rfc822(date)]]);
      });
    });
  });
