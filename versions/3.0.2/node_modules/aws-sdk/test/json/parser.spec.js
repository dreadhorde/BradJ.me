    ...
    return describe('parse', function() {
      ...
      describe('structures', function() {
        ...
        it('translates input', function() {
          ...
          return expect(parse(rules, params)).toEqual({
            "Items": {
              "A": "a",
              "B": "b"
            }
        ...
        return it('ignores null', function() {
          return expect(parse(rules, '{"Items": null}')).toEqual({});
        });
      });
      ...
      it('translates nested maps', function() {
        ...
        return expect(parse(rules, str)).toEqual(params);
      });
      it('traslates nested timestamps', function() {
        ...
        return expect(parse(rules, '{"Build":{"When":"' + formatted + '"}}')).toEqual(params);
      });
      return it('translates binary types', function() {
        ...
        return expect(data.Binary2.toString()).toEqual('\u0001\u0002\u0003');
      });
    });
  });
