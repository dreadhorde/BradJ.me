    ...
    describe('buildRequest', function() {
      ...
      describe('uri', function() {
        ...
        it('appends to existing httpRequest endpoint', function() {
          ...
          return expect(build().httpRequest.path).toEqual('/foo/bar/Owner/abc');
        });
        ...
        it('replaces param with empty string', function() {
          ...
          return expect(build().httpRequest.path).toEqual('/Owner/');
        });
        ...
        it('accpets multiple query params with uri params', function() {
          ...
          return expect(build().httpRequest.path).toEqual('/abc/xyz?bar=bar');
        });
        return it('uri escapes params in both path and querystring', function() {
          ...
          return expect(build().httpRequest.path).toEqual('/a%20b?query=a%2Fb');
        });
      });
      describe('headers', function() {
        ...
        it('populates the headers type translations', function() {
          ...
          return expect(build().httpRequest.headers['count']).toEqual('123');
        });
      ...
      describe('timestamp header with format', function() {
        return it('populates the header with correct timestamp formatting', function() {
          ...
          return expect(build().httpRequest.headers['If-Modified-Since']).toEqual(date.toUTCString());
        });
      });
      ...
      return describe('timestamp header with iso formatting', function() {
        return it('populates the header using the parameter formatting', function() {
          ...
          return expect(build().httpRequest.headers['If-Modified-Since']).toEqual(date.toISOString());
        });
      });
    });
    return describe('extractData', function() {
      ...
      describe('headers', function() {
        it('extracts header values', function() {
          ...
          return expect(extract().data.ContentType).toEqual('text/plain');
        });
        ...
        return it('adds empty map if no matching headers are found', function() {
          ...
          return expect(extract().data.Metadata).toEqual({});
        });
      });
      return describe('status code', function() {
        it('extracts the http status when instructed to', function() {
          ...
          return expect(extract().data.Result).toEqual(200);
        });
        return it('casts string status codes to integers', function() {
          ...
          return expect(extract().data.Result).toEqual(202);
        });
      });
    });
  });
