  ...
  describe('AWS.SequentialExecutor', function() {
    ...
    describe('emit', function() {
      it('emits to all listeners', function() {
        ...
        return expect(list).toEqual([1, 2, 3]);
      });
      it('stops emitting if error is returned', function() {
        var list;
        list = [];
        this.emitter.on('event1', function() {
          return list.push(1);
        ...
        expect((function(_this) {
          return function() {
            return _this.emitter.emit('event1');
          };
        })(this)).toThrow('error');
        return expect(list).toEqual([1, 2]);
      });
      return it('stops emitting if error is returned (async)', function() {
        var list;
        list = [];
        this.emitter.on('event1', function() {
          return list.push(1);
    ...
    if (AWS.util.isNode()) {
      return describe('domain support', function() {
        ...
        return it('supports domains', function() {
          ...
          return expect(thrown.name).toEqual('ReferenceError');
        });
      });
    }
  });
